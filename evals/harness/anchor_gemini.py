...
Usage:
    python evals/harness/anchor_gemini.py --data-dir data/doc_eval/nepali_pdf_v2 \
        --readings out/anchor/anchor_readings.json --out out/anchor_gemini
    python evals/harness/eval_anchor.py --score --verified out/anchor_gemini/verified \
