...
Usage:
    python evals/harness/eval_document.py --build-synthetic 8 --levels mild,medium \
        --ocr rapidocr,tesseract --methods clean,raw,sauvola,lanczos2 \
        --json out/doc_smoke.json
    python evals/harness/eval_document.py --data-dir data/doc_eval/pdf --methods clean,raw,sauvola,restore
    python evals/harness/eval_document.py --build-devanagari 12 --script ne --lang ne \
